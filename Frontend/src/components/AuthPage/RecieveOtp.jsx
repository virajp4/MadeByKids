    ...
    <form className="space-y-4 md:space-y-6" onSubmit={onVerifyOtp}>
      <div>
        ...
        <div className="flex items-center mt-2">
          <div className="flex-shrink-0 inline-flex items-center py-2.5 px-2.5 text-sm font-medium text-center text-gray-900 bg-gray-100 border border-gray-300 rounded-s-lg hover:cursor-default">
            +91{" "}
          </div>
      ...
      <div>
        ...
        <div className="max-w-[260px] mx-auto mt-4">
          <button
            ...
            className={`w-full inline-flex justify-center whitespace-nowrap rounded-lg  px-3.5 py-2.5 text-sm font-medium text-white shadow-sm shadow-indigo-950/10 ${
        ...
        <div className="text-sm text-slate-500 mt-4 items-end">
          Didn't receive code?{" "}
        ...
        <div className="text-sm text-slate-500 mt-4 items-end">
          Incorrect phone?{" "}
          <button className="font-medium text-indigo-500 hover:text-indigo-600" onClick={onChangeNumber}>
            Change Number
          </button>
        </div>
      </div>
